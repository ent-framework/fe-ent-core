...
import parseInterface from './utils/parse-interface.js';
import { getTemplate, toKebabCase } from './utils/index.js';
import { slotTagHandler } from './handlers/slot-tag-handler.js';
import { propExtHandler } from './handlers/prop-ext-handler.js';
import { extendsExtHandler } from './handlers/extends-ext-handler.js';
...
const TEMPLATE_GLOB = `**/${MD_TEMPLATE}`;
