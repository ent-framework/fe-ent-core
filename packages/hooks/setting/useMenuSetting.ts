...
import { SIDE_BAR_MINI_WIDTH, SIDE_BAR_SHOW_TIT_MINI_WIDTH } from '@ent-core/enums/appEnum';
import { MenuModeEnum, MenuTypeEnum, TriggerEnum } from '@ent-core/enums/menuEnum';
import { useFullContent } from '@ent-core/hooks/web/useFullContent';
