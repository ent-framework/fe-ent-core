...
<script lang="ts" setup>
  ...
  import loginImg from 'fe-ent-core/assets/svg/login-box-bg.svg';
...
<style lang="less">
  ...
  html[data-theme='dark'] {
    .@{prefix-cls} {
      ...
      &::before {
        background-image: url(fe-ent-core/assets/svg/login-bg-dark.svg);
      }
  ...
  .@{prefix-cls} {
    ...
    &::before {
      ...
      height: 100%;
      margin-left: -48%;
      background-image: url(fe-ent-core/assets/svg/login-bg.svg);
