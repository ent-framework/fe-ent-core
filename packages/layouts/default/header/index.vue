...
<script lang="ts">
  ...
  import { MenuModeEnum, MenuSplitTyeEnum } from 'fe-ent-core/enums/menuEnum';
  ...
  export default defineComponent({
    ...
    components: {
      ...
      AppSearch,
      ErrorAction,
      SettingDrawer: createAsyncComponent(() => import('fe-ent-core/layouts/default/setting/index.vue'), {
        loading: true,
      }),
    },
    props: {
