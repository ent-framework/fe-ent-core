...
<script lang="ts">
  ...
  import { useDesign, useGlobSetting, useGo, useI18n, useMenuSetting } from 'fe-ent-core';
  ...
  import { getChildrenMenus, getCurrentParentPath, getShallowMenus } from 'fe-ent-core';
...
<style lang="less">
  @layout-mix-sider-prefix-cls: ~'@{vben-prefix}-layout-mix-sider';
  @width: 80px;
  .@{layout-mix-sider-prefix-cls} {
    position: fixed;
    top: 0;
    left: 0;
    ...
    &.light {
      .@{layout-mix-sider-prefix-cls}-logo {
      ...
      .@{layout-mix-sider-prefix-cls}-module {
        &__item {
          font-weight: normal;
          color: rgb(0 0 0 / 65%);
      ...
      .@{layout-mix-sider-prefix-cls}-menu-list {
        &__content {
