...
export const themeRoot = resolve(epRoot, 'theme');
export const hookRoot = resolve(epRoot, 'hooks');
export const localeRoot = resolve(epRoot, 'locales');
export const directiveRoot = resolve(epRoot, 'directives');
export const utilRoot = resolve(epRoot, 'utils');
