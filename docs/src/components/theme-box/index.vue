      ...
      <template v-if="isLoading">
        <Col v-for="(_, index) of loadingFillArray" :key="index" :span="8">
          <Card v-if="isLoading" class="theme-box-card">
            ...
            <Skeleton animation>
              <SkeletonShape
                style="width: 100px; height: 24px; margin-top: 20px; margin-left: auto"
              />
            </Skeleton>
          </Card>
        </Col>
