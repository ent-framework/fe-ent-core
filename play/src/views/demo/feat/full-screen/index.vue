<template>
  <ent-page-wrapper title="全屏示例">
    <ent-collapse-container class="w-full h-32 rounded-md" title="Window Full Screen">
      ...
      <ent-button type="success" class="mr-2" @click="toggle">
        Toggle Window Full Screen
      </ent-button>

      <ent-button type="error" class="mr-2" @click="exit"> Exit Window Full Screen </ent-button>
    ...
    <div ref="domRef" class="flex items-center justify-center w-1/2 h-64 mx-auto mt-10 rounded-md">
